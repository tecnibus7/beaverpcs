...
echo -e "55 20 * * * /etc/bus/apagado/notifica-ultimo-apagado.sh " | tee -a /var/spool/cron/crontabs/usuario
echo -e "45 20 * * * /etc/bus/apagado/notifica-apagado.sh " | tee -a /var/spool/cron/crontabs/usuario
